...
export default function ManualEntryPage() {
  ...
  const tourSteps = [
    { target: '.tour-entry-types', content: 'Here you can manually log materials, labour, or equipment. Choose the type of entry you want to record.', disableBeacon: true },
  ...
  useEffect(() => {
    if (selectedProject) {
      ...
      transactionAPI.getAll({ project: selectedProject, type: typeMap[entryType], limit: 5 })
