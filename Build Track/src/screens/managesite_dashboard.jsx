      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer", boxShadow: "0 4px 14px rgba(108,99,255,0.3)",
          }}
        >
          ← Go to Projects
        </button>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ flex: 1, padding: "24px 28px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <div style={{ marginBottom: 8 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 15, fontWeight: 700, color: "#6C63FF" }}>{progress}%</span>
              </div>
              <div style={{ height: 8, background: "#f0f0f0", borderRadius: 6, overflow: "hidden", marginBottom: 8 }}>
                <div style={{ width: `${progress}%`, height: "100%", background: "#6C63FF", borderRadius: 6, transition: "width 0.4s ease" }} />
              </div>
            </div>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 14, flexWrap: "wrap" }}>
              {milestones.map((m) => (
                <div key={m.phase} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  <div style={{ width: 22, height: 22, borderRadius: "50%", background: m.done ? "#6C63FF" : m.current ? "#ECEBFF" : "#f0f0f0", border: m.current ? "2px solid #6C63FF" : "none", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, color: m.done ? "#fff" : m.current ? "#6C63FF" : "#aaa", flexShrink: 0 }}>
                    {m.done ? "✓" : m.phase}
                  </div>
                  {!isMobile && <span style={{ fontSize: 12, color: m.done ? "#1a1a1a" : m.current ? "#6C63FF" : "#aaa", fontWeight: m.current ? 600 : 400 }}>{m.label}</span>}
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.4fr 1fr", gap: 16 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #ebebeb", padding: "20px", boxShadow: "0 1px 6px rgba(0,0,0,0.04)" }}>
            ...
            {loadingStats ? (
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 20 }}>
                ...
                <div style={{ background: "#ECEBFF", borderRadius: 10, padding: "12px 14px", border: "1px solid #E7E8F5" }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: "#6C63FF", letterSpacing: "0.06em", marginBottom: 6 }}>ACTUAL SPENT</div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span onClick={() => navigate("/reports")} style={{ fontSize: 12, color: "#6C63FF", fontWeight: 600, cursor: "pointer" }}>View Full Report</span>
            </div>
          </div>
          ...
          <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #ebebeb", padding: "20px", boxShadow: "0 1px 6px rgba(0,0,0,0.04)", display: "flex", flexDirection: "column" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18 }}>
              ...
              <span style={{ padding: "4px 12px", background: "#ECEBFF", color: "#6C63FF", fontSize: 12, fontWeight: 700, borderRadius: 6, border: "1px solid #E7E8F5" }}>
                ...
                <>
                  {shownWorkers.map((w) => (
                    <div key={w._id} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <div style={{ width: 40, height: 40, borderRadius: 10, background: "#ECEBFF", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 700, color: "#6C63FF", flexShrink: 0 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #ebebeb", padding: "20px", boxShadow: "0 1px 6px rgba(0,0,0,0.04)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
            ...
            <span onClick={() => navigate("/transaction")} style={{ fontSize: 13, color: "#6C63FF", fontWeight: 600, cursor: "pointer" }}>View History</span>
          </div>
