    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 20, fontSize: 13, color: "#888" }}>
          <span onClick={() => navigate("/projects")} style={{ color: "#6C63FF", cursor: "pointer", fontWeight: 500 }}>
            Projects
          </span>
          <span>›</span>
        ...
        <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #ebebeb", padding: "28px 32px", boxShadow: "0 1px 6px rgba(0,0,0,0.04)", maxWidth: 860, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 20, marginBottom: 20 }}>
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", background: "#f9f9f9", border: "1px solid #e5e5e5", borderRadius: 10, padding: "11px 14px", gap: 8 }}>
                <span style={{ fontSize: 14, color: "#6C63FF", fontWeight: 600 }}>₹</span>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 20, marginBottom: 20 }}>
            ...
            <div>
              ...
              <input
                ...
                style={{ width: "100%", accentColor: "#6C63FF", cursor: "pointer", marginTop: 10 }}
              />
            </div>
          </div>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div
              ...
              style={{
                border: `2px dashed ${dragOver ? "#6C63FF" : "#e5e5e5"}`,
                borderRadius: 12, padding: photoPreview ? 0 : "36px 20px",
                background: dragOver ? "#ECEBFF" : "#fafafa",
            ...
            >
              {photoPreview ? (
                ...
                <>
                  <div style={{ width: 48, height: 48, borderRadius: "50%", background: "#ECEBFF", border: "1px solid #E7E8F5", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22 }}>📷</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, alignItems: "center" }}>
            <button
              ...
              disabled={saving}
              style={{
                minHeight: 48, padding: "14px 0", background: "#6C63FF", color: "#fff",
                border: "none", borderRadius: 12, fontWeight: 700, fontSize: 15, cursor: saving ? "not-allowed" : "pointer",
                display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                boxShadow: "0 4px 14px rgba(108,99,255,0.3)", opacity: saving ? 0.6 : 1,
