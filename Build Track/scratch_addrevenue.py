...
with open(r'c:\build-track\Build-Track\Build Track\src\components\AddRevenueModal.jsx', 'w', encoding='utf-8') as f:
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
          <h2 style={{ margin: 0, fontSize: 20, fontWeight: 800 }}>Record Revenue</h2>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input 
            ...
            style={{ width: "100%", padding: "12px", border: "1.5px solid #E5E7EB", borderRadius: 10, fontSize: 15 }}
          />
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <textarea 
            ...
            style={{ width: "100%", padding: "12px", border: "1.5px solid #E5E7EB", borderRadius: 10, fontSize: 15, minHeight: 80, resize: "vertical" }}
          />
        </div>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <input
            ...
            style={{ width: "100%", padding: "10px", border: "1px dashed #D1D5DB", borderRadius: 8, fontSize: 14 }}
          />
        </div>

        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: 24, background: "#FFF", borderTop: "1px solid #E5E7EB", borderTopLeftRadius: 0, borderTopRightRadius: 0 }}>
          <button 
            onClick={handleSave} 
            disabled={saving || esignPolling}
            style={{ width: "100%", padding: 16, background: primaryBlue, color: "#FFF", border: "none", borderRadius: 12, fontSize: 16, fontWeight: 700, cursor: saving ? "not-allowed" : "pointer", opacity: saving ? 0.7 : 1 }}
          >
